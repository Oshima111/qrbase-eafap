            ...
            <section className="flex flex-col gap-4">
              ...
              <div className="bg-white rounded-[2.5rem] shadow-xl p-8 h-[580px] flex flex-col">
                <button 
                  ...
                  className="w-full bg-[#1e293b] text-white py-4 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-black shadow-lg mb-6 transition-all active:scale-95"
                >
                  + Add Team Member
                </button>
                  ...
                  {filteredMembers.length > 0 ? (
                    filteredMembers.map(m => (
                      <div 
                        ...
                        className={`p-5 rounded-[2rem] cursor-pointer transition-all border-2 active:scale-[0.98] ${selectedId === m.id && !isAdding ? 'bg-blue-50 border-blue-200 shadow-sm' : 'bg-white border-slate-50 hover:border-blue-100'}`}
                      >
                    ...
                    <div className="h-full flex flex-col items-center justify-center text-slate-300 gap-4 opacity-60">
                      <Icon path="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" className="w-16 h-16 stroke-[1.5]" />
                      <span className="text-[10px] font-black uppercase tracking-widest text-center px-4">No members found</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="bg-white rounded-[2.5rem] shadow-xl p-8 h-[580px] flex flex-col">
                ...
                <div className="space-y-6 flex-grow overflow-y-auto pr-1">
                  <div className="flex flex-col gap-2">
                    ...
                    <input 
                      className="w-full bg-[#f1f5f9] border-2 border-slate-100 rounded-xl p-3 text-xs font-bold outline-none focus:border-blue-500 uppercase transition-all"
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <select 
                      className="w-full bg-[#f1f5f9] border-2 border-slate-100 rounded-xl p-3 text-xs font-bold outline-none focus:border-blue-500 uppercase cursor-pointer transition-all"
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <input 
                      className="w-full bg-[#f1f5f9] border-2 border-slate-100 rounded-xl p-3 text-xs font-bold outline-none focus:border-blue-500 transition-all"
                ...
                {isAdding ? (
                  <button onClick={handleAddMember} className="w-full mt-8 bg-[#1e293b] text-white py-4 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-[#2563eb] shadow-lg transition-all active:scale-95">
                    Confirm & Add
                  </button>
                ) : (
                  <button 
                    onClick={() => handleRemoveMember(selectedId)} 
                    className="w-full mt-8 border-2 border-red-500 text-red-500 py-4 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-red-500 hover:text-white transition-all shadow-sm active:scale-95"
                  >
                    Remove Member
                  </button>
                )}
            ...
            <section className="flex flex-col gap-4">
              ...
              <div className="bg-[#1e293b] rounded-[2.5rem] shadow-xl p-8 h-[580px] flex flex-col items-center text-white relative overflow-hidden">
                ...
                <div className="mt-auto pt-8 border-t border-slate-700 w-full text-center">
                  <span className="text-[9px] font-black text-slate-600 uppercase tracking-widest">System ID: {selectedMember?.id || "---"}</span>
                </div>
              </div>
            </section>
          </div>
